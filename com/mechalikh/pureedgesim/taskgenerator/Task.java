...
public interface Task extends QueueElement {
	...
	/**
	 * Adds a delay for a specific hop in the network path
	 * @param hopNumber The hop number
	 * @param delay The delay value to add
	 */
	void addHopDelay(int hopNumber, double delay);
	
	/**
	 * Gets the delay for a specific hop
	 * @param hopNumber The hop number
	 * @return The delay for that hop
	 */
	double getHopDelay(int hopNumber);
	
	/**
	 * Gets all hop delays
	 * @return Map of hop numbers to their delays
	 */
	Map<Integer, Double> getAllHopDelays();
}
