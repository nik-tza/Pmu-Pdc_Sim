 ...
 */
public class PmuNetworkModel extends DefaultNetworkModel {
    ...
    public PmuNetworkModel(SimulationManager simulationManager) {
        super(simulationManager);
        
        System.out.println("PmuNetworkModel - Initialized with SimulationParameters, realistic jitter, and distance-based delays");
        System.out.printf("PmuNetworkModel - Distance delays: %s (%.0fμs/m)%n", 
    ...
    private void handlePmuDataTransfer(ComputingNode from, ComputingNode to, Task task, double dataSize, TransferProgress.Type type) {
        ...
        if (PmuLogger.getInstance() != null) {
            PmuLogger.getInstance().logPmuNetworkTransfer(task, transferResult);
        }
    }
    ...
    private void handlePmuDataTransferFinished(TransferProgress transfer) {
        ...
        // Our custom PmuTaskOrchestrator will then collect the PMU data
    ...
    private ComputingNode findClosestGnbForPmu(ComputingNode pmu) {
        ...
        try {
            ...
            System.err.println("PmuNetworkModel - Error finding closest GNB for PMU: " + e.getMessage());
            return null;
        }
    }
    ...
    private ComputingNode findTelcoNode() {
        try {
            ...
            System.err.println("PmuNetworkModel - Error finding TELCO node: " + e.getMessage());
        }
        return null;
    }
    ...
    private ComputingNode findTsoNode() {
        try {
            ...
            System.err.println("PmuNetworkModel - Error finding TSO node: " + e.getMessage());
        }
        return null;
    }
    ...
    private String findGnbForPmu(ComputingNode pmu) {
        ...
        try {
            ...
            System.err.println("PmuNetworkModel - Error finding GNB for PMU: " + e.getMessage());
        }
