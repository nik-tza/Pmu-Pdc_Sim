 ...
 */
public class PmuTaskOrchestrator extends DefaultOrchestrator {
    ...
    public PmuTaskOrchestrator(SimulationManager simulationManager) {
        ...
        System.out.println("PmuTaskOrchestrator - Initialized for DYNAMIC collection:");
    ...
    public void initialize() {
        ...
        if (tsoNode != ComputingNode.NULL) {
            ...
            if (dataCollector == null) {
                dataCollector = new PmuDataCollectorDynamic(simulationManager, tsoNode);
                if (simulationManager instanceof PmuSimulationManager) {
                    ((PmuSimulationManager) simulationManager).setDataCollector(dataCollector);
                }
            }
            
            // Log initialization
            simulationManager.getSimulationLogger().print("PmuTaskOrchestrator - DYNAMIC data collector initialized for TSO: " + tsoNode.getName());
            simulationManager.getSimulationLogger().print("PmuTaskOrchestrator - Initialized for DYNAMIC collection:");
            ...
            simulationManager.getSimulationLogger().print("PmuTaskOrchestrator - ERROR: No TSO node found!");
        }
    }
    ...
    public void orchestrate(Task task) {
        ...
        if (dataCollector != null) {
            ...
            simulationManager.getSimulationLogger().print("PmuTaskOrchestrator - ERROR: Dynamic data collector not initialized");
        }
    }
    ...
    private ComputingNode findTsoCloudDatacenter() {
        ...
        if (!cloudDatacenters.isEmpty()) {
            System.out.println("PmuTaskOrchestrator - TSO not found, using first cloud: " + 
    ...
    public void resultsReturned(Task task) {
        ...
        if (isGridAnalysisTask) {
            ...
            PmuLogger.getInstance().logGridAnalysisTaskCompletion(task, success);
    ...
    private void handleGridAnalysisComplete(Task task) {
        ...
        String taskType = task.getType();
        System.out.printf("PmuTaskOrchestrator - Grid analysis completed: %s at time %.4f%n", 
        ...
        try {
            ...
            if (parts.length >= 4) {
                ...
                System.out.printf("PmuTaskOrchestrator - Grid analysis for %s: %s data (%s)%n", 
